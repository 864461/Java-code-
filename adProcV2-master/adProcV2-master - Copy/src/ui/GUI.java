...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtLength, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
        ...
        addBtn.setBackground(new java.awt.Color(181, 218, 181));
        ...
        clearBtn.setBackground(new java.awt.Color(168, 136, 136));
        ...
        jLabel5.setText("Size: m = Metres          Minimum Size: 0.1m          Maximum: 5m");
        ...
        clearOrderBtn.setBackground(new java.awt.Color(168, 136, 136));
        clearOrderBtn.setText("Clear Basket");
        ...
        boxDetailsBtn.setBackground(new java.awt.Color(213, 213, 209));
        boxDetailsBtn.setText("Order Details");
        ...
        removeBoxBtn.setBackground(new java.awt.Color(186, 181, 181));
        removeBoxBtn.setText("Remove Order");
        ...
        checkOutBtn.setBackground(new java.awt.Color(181, 218, 181));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(clearOrderBtn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//            " | Box Type: " + box.getBoxTypeName()
    ...
    private void sendBoxAdded(CardboardBox box) {
        JOptionPane.showMessageDialog(this, "Box Added! \nPrice: £" + String.format("%.2f", box.calculateTotalPrice()), "Order Added", JOptionPane.INFORMATION_MESSAGE);
    }
//    "\nBox Type: " + box.getBoxTypeName()
    ...
    private void boxDetailsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boxDetailsBtnActionPerformed
        ...
        if (index >= basketList.getItemCount() || index == -1) {
            JOptionPane.showMessageDialog(this, "Please select the Order you wish to View", "View Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void removeBoxBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeBoxBtnActionPerformed
        int index = basketList.getSelectedIndex();
        if (index >= basketList.getItemCount() || index == -1) {
            JOptionPane.showMessageDialog(this, "Please select the Order you wish to remove", "Remove Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void showDetails(CardboardBox box, int index) {
        ...
        JOptionPane.showMessageDialog(this,"Width: " + all[2]
                + "\nLength: " + all[4]
                + "\nHeight: " + all[3]
                + "\nColour: " + all[0]
                + "\nGrade: " + all[5]
