 ...
 */
public class CardboardBoxIV extends CardboardBox{

    public CardboardBoxIV(int quantity, double width, double length, double height, int grade, boolean sealableTop) {
    ...
    public double calculateTotalPrice() {
        ...
        double extras = priceWithoutExtras * (twoColourPerc + reinforcedBottomsPerc);
